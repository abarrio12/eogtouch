...
class App:
    ...
    def log_event(self, e, value: int | float | str):
        ...
        self.events.append({"timestamp": ts, "event": event_type, "color": self._state.stimuli_color.value, "key": key_name, "value": value, "error": self._state._errors_count, "iteracion": self._state._current_iteration})

    def save_events(self):
        save_dir = r"C:\Users\Ana\Documents\Ing Salud\TFG\codigo\data"  # Usa raw string para evitar problemas con \
